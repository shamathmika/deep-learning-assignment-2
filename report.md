...
![Frontend main UI](data/assignment_screenshots/frontend-main.png)
![Frontend main Benchmark UI](data/assignment_screenshots/frontend-main-benchmark.png)
...
![Frontend video detection UI](data/assignment_screenshots/frontend-image-detection.png)
...
![Benchmark mAP results](data/assignment_screenshots/backend-run-eval.png)
